...
const cirySearchButton = document.getElementById('city-search-button')
...
const api_key = "62f18a8163f9bd8701062df6505c8af5";

cirySearchButton.addEventListener("click", () => {
...
navigator.geolocation.getCurrentPosition(
    ...
    (err) => {
        if (err.code === 1) {
            alert("Usuário negou a localização")
        }else {
            console.log(err)
        }
